...
<img src="assets/img/Charlie_shoots.gif" align="right" width="160" height="140" hspace="10"/>  <em>Charlie Chaplin in "A Film Johnnie"</em>  Movies are not only impacted by technological advancements but are also a reflection of the world's innovation and the evolution of the minds of their creators. In the following plot down below, for example, we can clearly see the impact of real-world wars on the number of war films made during the last century. 
